                        ...
                        if (data[0] != "error") {
                            if (data[0] == true) {
                                ...
                                if (spotify != data[1][0]) {
                                    ...
                                    var author = data[1][1];
                                    if (title.length <= 13) {
                                        spawn("python",["/home/node/python/line.py",1,title + " by"]);
                                        lines[0] = title + " by";
                                        setTimeout(() => {
                                            spawn("python",["/home/node/python/line.py",2,author]);
                                            lines[1] = author;
                                            setTimeout(() => {
                                                spawn("python",["/home/node/python/line.py",3,""]);//clear line
                                                lines[2] = "";
                                            }, 200);
                                        }, 200);
                                    } else if (title.length <= 15) {
                                        spawn("python",["/home/node/python/line.py",1,title]);
                                        lines[0] = title + " by";
                                        setTimeout(() => {
                                            spawn("python",["/home/node/python/line.py",2,"by " + author]);
                                            lines[1] = "by " + author;
                                            setTimeout(() => {
                                                spawn("python",["/home/node/python/line.py",3,""]);//clear line
                                                lines[2] = "";
                                        ...
                                        spawn("python",["/home/node/python/line.py",1,title.substring(0,13) + " -"]);
                                        lines[0] = title.substring(0,13) + " -";
                                        setTimeout(() => {
                                            spawn("python",["/home/node/python/line.py",2,title.substring(13,13+12) + " by"]);
                                            lines[1] = title.substring(13,13+12) + " by";
                                            setTimeout(() => {
                                                spawn("python",["/home/node/python/line.py",3,author]);
                                                lines[2] = author;
                                            }, 200);
                                        }, 200);
                                    }
                                ...
                                if (spotify != "") {
                                    ...
                                    restore([lines[3],lines[4],lines[5],lines[6],lines[7]]);
                                }
                            }
                        } else {
                            if (spotify != "Spotify not connected.") {
                                spotify = "Spotify not connected.";
                                lines[0] = "Spotify not connected."; lines[1] = ""; lines[2] = "";
                                setTimeout(() => {
                                    spawn("python",["/home/node/python/line.py",1,spotify]);
                                }, 400);
                            }
                        }
                    } catch (err) {
...
function line(lineNum, text, bool) {
    ...
    lines[_lineNum+3] = ((text == null || text == "" || text == "null") ? " " : text);
    spawn("python",["/home/node/python/line.py",_lineNum+3,((text == null || text == "") ? " " : text)]);
}
function clear(bool) {
    restore(["","","","",""]);
    //spawn("python",["/home/node/python/clear.py"]);
}
function restore(linesList, bool) {
    for (var i = 0; i < (linesList.length < 5 ? linesList.length : 5); i++) {
        lines[i+3] = (((linesList[i] == null || linesList[i] == "" || linesList[i] == "null") ? " " : linesList[i]));
    }
    spawn("python",["/home/node/python/restore.py",lines[0],lines[1],lines[2],lines[3],lines[4],lines[5],lines[6],lines[7]]);
}
